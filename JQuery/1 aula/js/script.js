...
/*
$(function(){
    // mostra uma largura e conta o espaçamento: ex: width 20px; padding 5px; = 15px: 
    var elwidth = $('.box').width();

    console.log('width:'+$('.box').width());

    // mostra a largura inteira do elemento
    console.log('inner width:'+$('.box').innerWidth());

    // mostra uma largura e conta com a borda
    console.log('outer width:'+$('.box').outerWidth());

    // mostra uma largura e conta o espaçamento: ex: width 20px; padding 5px; = 15px: 
    var elwidth = $('.box').height();
